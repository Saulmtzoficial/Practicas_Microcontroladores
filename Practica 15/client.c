            ...
            switch (hci_event_packet_get_type(packet)) {
                ...
                case GATT_EVENT_QUERY_COMPLETE:
                    ...
                    if (att_status != ATT_ERROR_SUCCESS) {
                        printf("SERVICE QUERY RESULT, ATT Error 0x%02x.\n", att_status);
                    ...
                    gatt_client_discover_characteristics_for_service_by_uuid16(
                        ...
                        &server_service, ORG_BLUETOOTH_CHARACTERISTIC_TEMPERATURE);
                    break;
                default:
                    break;
            }
        ...
        case TC_W4_CHARACTERISTIC_RESULT:
            switch (hci_event_packet_get_type(packet)) {
                ...
                case GATT_EVENT_QUERY_COMPLETE:
                    att_status = gatt_event_query_complete_get_att_status(packet);
                    if (att_status != ATT_ERROR_SUCCESS) {
                        printf("CHARACTERISTIC QUERY RESULT, ATT Error 0x%02x.\n", att_status);
                        gap_disconnect(connection_handle);
                        break;
                    }
    ...
    switch (event_type) {
        ...
        case GAP_EVENT_ADVERTISING_REPORT:
            ...
            if (!advertisement_report_contains_service(
                    ORG_BLUETOOTH_SERVICE_ENVIRONMENTAL_SENSING, packet)) return;
